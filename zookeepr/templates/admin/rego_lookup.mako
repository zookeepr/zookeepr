...
%     else:
<b>Tentative</b> ${ registration.type } rego <a href="/registration/${registration.id}">${registration.id}</a>; <b>not paid</b>
%     endif
%   else:
not registered
%   endif
...
<p>Volunteering areas of interest: ${ registration.volunteer }</p>
%   endif

%   if registration.phone or person.phone:
<p>Phone: ${ registration.phone or person.phone }</p>
%   endif
...
%   if registration:
<p>T-shirt: ${ registration.teesize }
%     if registration.extra_tee_count:
plus ${  registration.extra_tee_count } extra: ${ registration.extra_tee_sizes }
%     endif
</p>
