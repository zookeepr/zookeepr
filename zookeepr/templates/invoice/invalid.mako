...
${ h.link_to('registration status page', url=h.url_for(controller='registration', action='status')) } or ${ h.contact_email('contact the committee') } to clear up the situation.</p>
