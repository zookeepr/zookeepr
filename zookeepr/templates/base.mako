...
% else:
             <li><a href="https://conf.linux.org.au/person/signin" ${ cls('login') |n}>Sign in</a></li>
% endif
            </ul>
% if h.signed_in_person():
...
% if h.url_for() == '/':
  <div id="sponsors">
    ...
    <p><a href="http://www.internetnz.org.nz"><img src="/images/sponsors-InternetNZ.png" alt="InternetNZ" title="Internet NZ works to keep the Internet open and uncaptureable, protecting and promoting the Internet for New Zealand." /></a></p>
  </div>
% endif
