        ...
        <p class="entries">${ h.text('social_network.url') }</p>
        <p class="note">Specify USER (in uppercase) in the URL for where the usersname should be inserted.  If no URL is specified, then whatever the user enters is used verbatim.</p>
