...
<br />
<span class="fielddesc">if your submission has a project URL, specify it here so the review committee can find out more about your submission.</span>
</p>
...
<span class="fielddesc">Please write here a summary of your submission.</span>
<br />
<% h.text_area('submission.abstract', cols=50, rows=10) %>
</p>

<p><label for="submission.experience">Experience:</label>
<span class="fielddesc">Have you had any experience presenting this submission elsewhere?  If so, we'd like to know.</span>
<br />
