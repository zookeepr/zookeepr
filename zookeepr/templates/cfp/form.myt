...
% #endfor
    ...
    <p class="label"><label for="proposal.abstract">Abstract:</label><span class="mandatory">*</span><span class="publishable">&#8224;</span></p>
    ...
    <p class="label"><label for="proposal.project">Project:</label><span class="mandatory">*</span><span class="publishable">&#8224;</span>
    <p class="entries"><% h.textfield('proposal.project', size=70) %></p>
    <p class="note">The name of the project you will be talking about.</p>

    <p class="label"><label for="proposal.url">Project homepage:</label><span class="mandatory">*</span><span class="publishable">&#8224;</span></p>
    ...
    <p class="label"><label>Travel &amp; Accommodation Assistance:</label><span class="mandatory">*</span></p>
    <p class="entries">
% for ta in c.tatypes:
...
%     c.person = c.signed_in_person
    <p class="label"><label for="name">Speaker name:</label><span class="mandatory">*</span><span class="publishable">&#8224;</span></p>
    ...
    <p class="label"><label for="person.mobile">Speaker mobile phone:</label><span class="mandatory">*</span><span class="publishable">&#8224;</span></p>
...
% #endif
    ...
    <p class="label"><label for="person.url">Speaker homepage:</label><span class="publishable">&#8224;</span></p>
