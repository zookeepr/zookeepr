...
and an appropriate room will be provided by the linux.conf.au team.
</p>
...
<ul>
<li>Open media, multi-media</li>
<li>Desktop environment</li>
<li>End-user applications, productivity apps</li>
</ul>
</li>
...
<p>
Papers and proposals should be submitted in an appropriate open
format, such as 7-bit ASCII text, HTML, DocBook or LaTeX.
</p>
...
<li>Affiliation with commercial or relevant organisations</li>
<li>Postal address</li>
<li>Telephone and/or mobile numbers, with area and country codes.</li>
<li>Short biography, in around 1 - 3 paragraphs. The biography should
  include any previous speaking or organising experience.</li>
</ul>
