...
%>
  ...
  <a href="http://facebook.com/sharer.php?t=${ h.url_escape(title + ' ' + h.lca_info["event_hashtag"]) }&u=${ url }"><img src="/images/tag_facebook.png" width="16" height="16" alt="[SU]" title="Set status on Twitter"></a>
