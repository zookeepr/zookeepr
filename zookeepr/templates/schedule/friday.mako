<table id="programme" style="" summary="Programme" cellpadding="" cellspacing="">
  ...
  <tbody>
    ...
    <tr class="odd">
      ...
      <td class="presentation" align="center" valign="top"><%include file="talk_link.mako" args="talk_id=158" /></td>
    ...
    <tr class="odd">
      ...
      <td class="tutorial" align="center" valign="top"><%include file="talk_link.mako" args="talk_id=166" /></td>
    ...
    <tr class="odd">
      ...
      <td class="presentation" align="center" valign="top"><%include file="talk_link.mako" args="talk_id=76" /></td>
