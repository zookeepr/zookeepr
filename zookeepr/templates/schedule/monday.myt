<table id="mon-programme" style="" summary="Programme" cellpadding="" cellspacing="">
  ...
  <tbody>
    ...
    <tr class="odd">
      ...
      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="Database", title="NDB/Bindings - Use the MySQL Cluster Direct API from languages you actually like for fun and profit", speaker="Monty Taylor" &></td>
      ...
      <td class="presentation" align="center" valign="top" style="border-right: none;"><& miniconf_talk_link.myt, miniconf="MobileDevices", title="A Linux multimedia platform for mobile processors", speaker="Conrad Parker" &></td>
    ...
    <tr class="odd">
      ...
      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="Database", title="InnoDB scaling up and performance", speaker="Bruce Huang" &></td>
      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="Kernel", title="TBA", speaker="David Woodhouse" &></td>
      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="Sysadmin", title="Rapid repeatable provisioning of Linux systems", speaker="Richard Keech" &></td>
      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="MythTV", title="Transcoding in MythTV", speaker="Paul Wayper" &></td>
      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="LinuxChix", title="On Speaking", speaker="Jacinta Richardson" &></td>
      <td class="presentation" align="center" valign="top" rowspan="2">
        <i>10:40 - 11:10</i> <& miniconf_talk_link.myt, miniconf="MobileDevices", title="Baglady 2.0 - A modular a/v streaming tool", speaker="Nancy Mauro-Flude" &>
        <i>11:20 - 11:50</i> <& miniconf_talk_link.myt, miniconf="MobileDevices", title="The Bits Noone Talks About", speaker="Mark Phillips" &>
        <i>12:00 - 12:30</i> <& miniconf_talk_link.myt, miniconf="MobileDevices", title="Funambol and SyncML", speaker="Mathew McBride" &>
      </td>
      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="DevBiz", title="Open Source Business models and engaging corporate and Govenment sectors in Australia", speaker="Jeff <i>and</i> Pia Waugh" &></td>
    </tr>
    <tr class="odd">
      <th class="programme_slot" align="center" valign="top">11:40&nbsp;-&nbsp;12:30</th>
      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="Database", title="OurDelta - Builds for MySQL", speaker="Arjen Lentz" &></td>
      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="Kernel", title="Linux Problem-Solving Hour", speaker="" &></td>
      <td class="presentation" align="center" valign="top">
        <i>11:40 - 12:05</i> <& miniconf_talk_link.myt, miniconf="Sysadmin", title="Automating system administration", speaker="Devdas Bhagat" &>
        <i>12:05 - 12:30</i> <& miniconf_talk_link.myt, miniconf="Sysadmin", title="A new device mapper snapshot implementation", speaker="Tomonori Fujita" &>
      </td>
    ...
    <tr class="odd">
      ...
      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="Database", title="The Security-Enhanced PostgreSQL - \"System-wide consistency\" in access controls", speaker="KaiGai Kohei" &></td>
      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="Kernel", title="How I Learned To Stop Worrying And Love ACPI", speaker="Matthew Garrett" &></td>
      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="Sysadmin", title="Lightning Talks", speaker="" &></td>
      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="MythTV", title="Debugging DTV", speaker="Steven Ellis" &></td>
      <td class="presentation" align="center" valign="top">
        <i>13:50 - 14:15</i> <& miniconf_talk_link.myt, miniconf="LinuxChix", title="Digitising the paper panopticon", speaker="Claudine Chionh" &>
        <i>14:20 - 14:45</i> <& miniconf_talk_link.myt, miniconf="LinuxChix", title="Great Firewall of Australia: The Swiss Cheese Project ", speaker="Aeriana Lee" &>
      </td>
      <td class="presentation" align="center" valign="top" rowspan="2">
    ...
    <tr class="odd">
      ...
      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="Database", title="Maria, the new storage engine for MySQL", speaker="Michael Widenius" &></td>
      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="Kernel", title="Large CPUmasks", speaker="Rusty Russell" &></td>
      <td class="presentation" align="center" valign="top">
        <i>14:50 - 15:15</i> <& miniconf_talk_link.myt, miniconf="Sysadmin", title="Free and Open Source Software in Environmental Forecasting", speaker="Christopher Edsall" &>
        <i>15:15 - 15:40</i> <& miniconf_talk_link.myt, miniconf="Sysadmin", title="System-level Performance Management with PCP", speaker="Nathan Scott" &>
      </td>
      <td class="presentation" align="center" valign="top">
    ...
    <tr class="odd">
      ...
      <td class="presentation" align="center" valign="top" rowspan="2">
        <i>16.00 - 16.25</i> <& miniconf_talk_link.myt, miniconf="LinuxChix", title="Chixbits", speaker="Robyn Willison" &>
        <i>16.25 - 16.50</i> <& miniconf_talk_link.myt, miniconf="LinuxChix", title="Planning session for next Chix event", speaker="" &>
    ...
    <tr class="odd">
      ...
      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="Database", title="Lightning Talks", speaker="" &></td>
      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="Kernel", title="Ask a Kernel Hacker Panel", speaker="" &></td>
      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="Sysadmin", title="Managing systems with Red Hat Satellite", speaker="Richard Keech" &></td>



      <td class="presentation" align="center" valign="top"><& miniconf_talk_link.myt, miniconf="DevBiz", title="Did Hell Freeze Over?", speaker="Lawrence Crumpton" &></td>
    </tr>
  </tbody>
</table>
