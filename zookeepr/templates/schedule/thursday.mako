<table id="thur-programme" style="" summary="Programme" cellpadding="" cellspacing="">
  ...
  <tbody>
    ...
    <tr class="odd">
      ...
      <td class="tutorial" align="center" valign="top"><%include file="talk_link.mako" args="talk_id=67" /></td>
    </tr>
    <tr class="odd">
      ...
      <td class="tutorial" align="center" valign="top"><%include file="talk_link.mako" args="talk_id=161" /></td>
    </tr>
    <tr class="even">
    ...
    <tr class="odd">
      ...
      <td class="presentation" align="center" valign="top"><%include file="talk_link.mako" args="talk_id=143" /></td>
      <td class="presentation" align="center" valign="top"><%include file="talk_link.mako" args="talk_id=181" /></td>
      <td class="presentation" align="center" valign="top"><%include file="talk_link.mako" args="talk_id=151" /></td>
...
<td class="presentation" align="center" valign="top"><%include file="talk_link.mako" args="talk_id=151" /></td>
    ...
    <tr class="odd">
      ...
      <td class="tutorial" align="center" valign="top"><%include file="talk_link.mako" args="talk_id=92" /></td>
    </tr>
    <tr class="odd">
      ...
      <td class="tutorial" align="center" valign="top"><%include file="talk_link.mako" args="talk_id=119" /></td>
    </tr>
  </tbody>
</table>
