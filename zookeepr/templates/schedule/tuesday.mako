  ...
  <tbody>
    ...
    <tr class="odd">
      ...
      <td class="miniconf" align="center" valign="top">
        ...
        <%include file="miniconf_talk_link.mako" args="miniconf='SystemAdministration', time='11:45 - 12:15', speaker='Sander van Vugt', title='Setting up a HA cluster in 20 minutes + avoiding common errors'"/>
      </td>
      <td class="miniconf" align="center" valign="top">
        <%include file="miniconf_talk_link.mako" args="miniconf='Rocket', time='10:30 - 12:15', speaker='', title='Working Session'"/>
      </td>
      <td class="miniconf" align="center" valign="top">
        <%include file="miniconf_talk_link.mako" args="miniconf='MobileFOSS', time='10:30 - 10:35', speaker='', title='Welcome to the Miniconf'"/>
        <%include file="miniconf_talk_link.mako" args="miniconf='MobileFOSS', time='10:35 - 11:00', speaker='James Purser', title='Planning Alerts AU'"/>
        <%include file="miniconf_talk_link.mako" args="miniconf='MobileFOSS', time='11:00 - 11:30', speaker='Mateu Batle', title='Meego Garage Client Infrastructure'"/>
        <%include file="miniconf_talk_link.mako" args="miniconf='MobileFOSS', time='11:30 - 12:00', speaker='Tony Wasserman', title='Cross-Platform Mobile Application Development Tool'"/>
      </td>
      <td class="miniconf" align="center" valign="top">
        <%include file="miniconf_talk_link.mako" args="miniconf='DataStorage', time='10:30 - 11:00', speaker='Arjen Lentz', title='Understanding Joins in half an hour'"/>
        <%include file="miniconf_talk_link.mako" args="miniconf='DataStorage', time='11:00 - 11:30', speaker='Maksim Lin', title='Redis - Quick and Simple'"/>
      </td>
      <td class="miniconf" align="center" valign="top">
    ...
    <tr class="odd">
      ...
      <td class="miniconf" align="center" valign="top">
        <%include file="miniconf_talk_link.mako" args="miniconf='MulticoreAndParallel', time='13:30 - 14:20', speaker='Paul McKenney - CTO Linux, IBM', title='Is Parallel Programming Hard, And If So, Why?'"/>
      ...
      <td class="miniconf" align="center" valign="top">
        ...
        <%include file="miniconf_talk_link.mako" args="miniconf='SystemAdministration', time='14:55 - 15:15', speaker='Craig Askings', title='Defending voip on the internet'"/>
      </td>
      <td class="miniconf" align="center" valign="top">
        <%include file="miniconf_talk_link.mako" args="miniconf='Rocket', time='10:30 - 12:15', speaker='', title='Working Session'"/>
      </td>
      <td class="miniconf" align="center" valign="top">
        <%include file="miniconf_talk_link.mako" args="miniconf='MobileFOSS', time='13:00 - 13:30', speaker='Alan Alpert', title='Qt Quick For Mobile UIs'"/>
        <%include file="miniconf_talk_link.mako" args="miniconf='MobileFOSS', time='13:30 - 14:00', speaker='Angus Lees', title='Writing Android Native C/C++ Apps'"/>
        <%include file="miniconf_talk_link.mako" args="miniconf='MobileFOSS', time='14:00 - 14:30', speaker='Lorn Potter', title='Linux Mobile Devices - A Potted History'"/>
        <%include file="miniconf_talk_link.mako" args="miniconf='MobileFOSS', time='14:30 - 15:00', speaker='', title='TBA'"/>
        <%include file="miniconf_talk_link.mako" args="miniconf='MobileFOSS', time='15:00 - 15:15', speaker='', title='Pimp Your Project'"/>
      </td>
      <td class="miniconf" align="center" valign="top">
        <%include file="miniconf_talk_link.mako" args="miniconf='DataStorage', time='13:00', speaker='Monty Taylor', title='OpenStack Storage: Swift'" />
      ...
      <td class="miniconf" align="center" valign="top">
        ...
        <%include file="miniconf_talk_link.mako" args="miniconf='ResearchAndStudentInnovation', time='14:55', speaker='Shane Geddes &amp; Andrew Hill &amp; Lekshmen Kannan', title='E-Learning with FLOSS'"/>
      </td>
      <td class="miniconf" align="center" valign="top">
    ...
    <tr class="odd">
      ...
      <td class="miniconf" align="center" valign="top">
        <%include file="miniconf_talk_link.mako" args="miniconf='MulticoreAndParallel', time='15:45 - 16:10', speaker='John Williams - CEO, PetaLogix and Lecturer, University of Queensland', title='Multicore vs FPGAs'"/>
        <%include file="miniconf_talk_link.mako" args="miniconf='MulticoreAndParallel', time='16:10 - 16:35', speaker='Tim Uckun - Solutions Architect, Enspiral', title='Painless Parallelization with Gearman'"/>
        <%include file="miniconf_talk_link.mako" args="miniconf='MulticoreAndParallel', time='16:35 - 17:00', speaker='Wayne Kelly - Senior Lecturer, QUT', title='Discovering Inherent Parallelism in Sequential Programs'"/>
        ...
        <%include file="miniconf_talk_link.mako" args="miniconf='MulticoreAndParallel', time='17:20 - 17:30', speaker='', title='Birds of a Feather'"/>
      </td>
      <td class="miniconf" align="center" valign="top">
      ...
      <td class="miniconf" align="center" valign="top">
        ...
        <%include file="miniconf_talk_link.mako" args="miniconf='SystemAdministration', time='17:15 - 17:30', speaker='Lindsay Holmwood', title='En-Visage-ing system and instrumented statistics'"/>
      </td>
      <td class="miniconf" align="center" valign="top">
        <%include file="miniconf_talk_link.mako" args="miniconf='Rocket', time='10:30 - 12:15', speaker='', title='Working Session'"/>
      </td>
      <td class="miniconf" align="center" valign="top">
        <%include file="miniconf_talk_link.mako" args="miniconf='MobileFOSS', time='15:45 - 16:15', speaker='Nick Hodge', title='MahTweets'"/>
        <%include file="miniconf_talk_link.mako" args="miniconf='MobileFOSS', time='16:15 - 16:45', speaker='', title='TBA'"/>
        <%include file="miniconf_talk_link.mako" args="miniconf='MobileFOSS', time='16:45 - 17:15', speaker='', title='TBA'"/>
      </td>
      <td class="miniconf" align="center" valign="top">
        <%include file="miniconf_talk_link.mako" args="miniconf='DataStorage', time='15:45', speaker='Arjen Lentz', title='MariaDB, or how MySQL didn\'t die with the Sun/Oracle take-overs.'"/>
        <%include file="miniconf_talk_link.mako" args="miniconf='DataStorage', time='16:15', speaker='', title='Lightning talks'"/>
      </td>
      <td class="miniconf" align="center" valign="top">
        ...
        <%include file="miniconf_talk_link.mako" args="miniconf='ResearchAndStudentInnovation', time='17:10', speaker='', title='Student Innovation Lightning Talks'"/>
      </td>
