...
%else:
<p>${ h.checkbox('person.i_agree', readonly=True) } <label for="personi_agree">I agree to the</label> <a href="/cor/terms_and_conditions" target="_blank">conditions of registration</a></p>
%endif
