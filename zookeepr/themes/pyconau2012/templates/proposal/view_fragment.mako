...
<p>I allow ${ h.lca_info["event_parent_organisation"] } to record my presentation.</p>

<p>${ allow(c.proposal.video_release) } ${ h.lca_info["event_parent_organisation"] } to release any
recordings of my presentation under the <a href="${ h.lca_info["media_license_url"] }">${ h.lca_info["media_license_name"] }</a></p>

<p>${ allow(c.proposal.slides_release) } ${ h.lca_info["event_parent_organisation"] } to release any other material (such as slides) from my presentation under the <a href="${ h.lca_info["media_license_url"] }">${ h.lca_info["media_license_name"] }</a>
</p>
