...
# Contact email for the committee
  'contact_email' : 'contact@pycon-au.org',
# All email sent by ZK will Bcc here:
  'bcc_email' : 'archive@pycon-au.org',
  'webmaster_email': 'webmaster@pycon-au.org',

# Event information
  'event_parent_organisation' : 'Linux Australia',
  'event_parent_url' : 'http://www.linux.org.au/',
  'event_name' : 'PyCon AU 2012',
  'event_shortname' : 'pyconau2012',
  'event_host' : 'pycon-au.org',
  'event_url' : 'http://pycon-au.org',
  'event_permalink' : 'http://pycon-au.org',
  'event_hashtag' : '#PYCONAU',
  'event_tax_number' : 'ABN 56 987 117 479',
  'event_postal_address' : 'GPO Box 4788 Sydney NSW 2001',
  'event_fax_number' : '',
  'event_phone_number': '',
  'event_byline': 'PyCon AU 2012 | 18-19 Sep | Hobart, Tasmania',
  'event_pricing_disclaimer': 'All prices are in Australian dollars and include 10% GST.',
  'date' : datetime(2012, 9, 18, 9, 0, 00),
  ...
  'invoice_message' : '', #needs better documentation
...
# Mode
  ...
  'proposal_update_email': 'archive@pycon-au.org', # recieve notifications when proposals are changed. Leave blank for none.
