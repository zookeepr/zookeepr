...
def setup(meta):
    meta.Session.add_all(
        [
            ProductCategory(name='Ticket', description='Please choose your registration type. See <a href="http://www.lca2011.linux.org.au/register/prices" target="_blank">the website</a> for a description of what is included in each ticket type.', display='radio', min_qty=1, max_qty=1, display_order=1),
