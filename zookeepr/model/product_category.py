...
def setup(meta):
    meta.Session.add_all(
        [
            ...
            ProductCategory(name='Rocketry', description='This ticket is purely for the Rocketry Miniconf, it covers supplies, travel to the launch site, insurance and a one-day Rocketry Club membership.', display='checkbox', min_qty=0, max_qty=1, display_order=100),
        ]
    )
