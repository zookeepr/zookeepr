...
def setup(meta):
    meta.Session.add_all(
        [
            ...
            ProductCategory(name='T-Shirt', description='Please choose how many t-shirts you would like.', note='One t-shirt is free with your registration, any others are $25.00 each. More details and measurements on t-shirt sizes can be found on the <a href="/register/shirts" popup="True">registration information</a>.', display='qty', display_mode='shirt', min_qty=1, max_qty=100, display_order=10),
            ...
            ProductCategory(name="Partners Programme", description="Please register your partner for the Partners Programme.", display='qty', min_qty=0, max_qty=50, display_mode='grid', display_order=40),
