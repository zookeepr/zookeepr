...
def upgrade():
    ...
    try:
        ...
        print ""
        print "The lca_menu and lca_submenus now live in zkpylons/config/menu.py"
        print "You must move the variables by hand, it is not automatic."
        print ""
...
def downgrade():
    ...
    print ""
    print "You should check this file and combine it with zkpylons/config/menu.py to generate"
