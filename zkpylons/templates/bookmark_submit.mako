...
%>
  ...
  <a href="http://facebook.com/sharer.php?t=${ h.url_escape(title + ' ' + c.config.get("event_hashtag")) }&u=${ url }"><img src="/images/sm_icons/facebook.png" width="16" height="16" alt="[SU]" title="Set status on Facebook"></a>
  ...
  <a href="http://twitter.com/home?status=${ h.url_escape(twit_title + url + ' ' + c.config.get("event_hashtag")) }"><img src="/images/sm_icons/twitter.png" width="16" height="16" alt="[SU]" title="Set status on Twitter"></a>
</div>
</%def>
