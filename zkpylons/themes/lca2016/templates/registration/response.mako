Subject: You're almost finished registering for ${ h.event_name() }
...
Please note that we are unable to confirm your registration until your invoice is paid.
You can view and pay your invoice here: ${ h.url_for(qualified=True, controller='registration', action='status') }
%endif
