...
%>
  ...
  <a href="http://facebook.com/sharer.php?t=${ h.url_escape(title + ' ' + h.lca_info["event_hashtag"]) }&u=${ url }"><img src="/img/sm_icons/facebook.png" width="32" height="32" alt="[SU]" title="Set status on Facebook"></a>
  ...
  <a href="http://twitter.com/home?status=${ h.url_escape(twit_title + url + ' ' + h.lca_info["event_hashtag"]) }"><img src="/img/sm_icons/twitter.png" width="32" height="32" alt="[SU]" title="Set status on Twitter"></a>
</div>
</%def>
